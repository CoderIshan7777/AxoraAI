...
const AiTools = () => {
    ...
    const {user} = useUser()
  return (
    <div className='px-4 sm:px-20 xl:px-32 bg-[#F5EFE6]'>
        <div className='text-center'>
            <h2 className='text-slate-700 text-[42px] pt-16 font-semibold'>Powerful AI Tools</h2>
        ...
        <div className='flex flex-wrap mt-10 pb-6 justify-center'>
            {AiToolsData.map((tool, index)=>(
                <div key={index} className='p-8 m-4 max-w-xs rounded-lg bg-[#E8DFCA]
                shadow-lg border border-blue-100 hover:-translate-y-1 transition-all
