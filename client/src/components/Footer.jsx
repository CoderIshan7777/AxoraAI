        ...
        <>
            ...
            <footer className="px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-[#F5EFE6] pt-10">
                    ...
                    <div className="flex flex-col lg:items-center lg:justify-center">
                        <div className="flex flex-col text-sm space-y-2.5">
                            ...
                            <a className="hover:text-slate-600 transition" href="#">
                                Careers
                                <span className="text-xs text-white bg-[#8a307f] rounded-md ml-2 px-2 py-1">
                                    We’re hiring!
                                </span>
                            </a>
                    ...
                    <div>
                        ...
                        <div className="text-sm space-y-6 max-w-sm">
                            ...
                            <div className="flex items-center justify-center gap-2 p-2 rounded-md bg-indigo-50">
                                ...
                                />
                                <button className="bg-[#8a307f] px-4 py-2 text-white rounded">
                                    Subscribe
                                </button>
                            </div>
                        </div>
                ...
                <p className="py-4 text-center border-t mt-6 border-slate-200">
                    Copyright 2025 © <a href="https://localhost:5173">AxoraAI</a> All Right Reserved.
                </p>
            </footer>
        </>
    )
