const Testimonial = () => {
    ...
    return (
        <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 pt-40 pb-30 bg-[#F5EFE6]">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 mt-20 mb-10">
                {testimonials.map((testimonial) => (
                    <div key={testimonial.id} className="bg-[#E8DFCA] p-6 rounded-xl shadow max-w-xs">
